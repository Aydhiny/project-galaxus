...
export const EMPTY_LEADERBOARD_DATA: LeaderboardData = {
...
/**
 * Pure — takes one user's checkin rows, derives every stat/streak. No I/O,
 * reused for both the personal and global leaderboard views. Lives outside
 * lib/actions/leaderboard.ts because "use server" files require every
 * top-level export to be an async function, and this one deliberately isn't.
 */
export function deriveLeaderboardData(rows: DailyCheckin[]): LeaderboardData {
